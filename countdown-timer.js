!(function($) {
  ...
  /* 
       ...
       */
  var Countdown = function(el, finalDate, options, startDate) {
    this.el = el;
    this.$el = $(el);
    this.interval = null;
    this.offset = {};
    ...
    this.startDate = startDate != undefined ? startDate : new Date();
  ...
  Countdown.prototype.start = function() {
    ...
    var self = this;
    diff = new Date().getTime() - self.startDate.getTime();
    this.update();
  ...
  Countdown.prototype.update = function() {
    ...
    this.elapsed = new Date() >= this.finalDate;
    this.offset = {
